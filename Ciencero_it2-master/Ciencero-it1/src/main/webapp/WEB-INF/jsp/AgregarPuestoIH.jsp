    ...
    <script>
        ...
        function initMap() {
            map = new google.maps.Map(document.getElementById("map"), {
                zoom: 17,
                center: {lat: 19.3234472, lng: -99.1818304}
            });
            marker = new google.maps.Marker({position: {lat: 19.3234472, lng: -99.1818304}, map: map, draggable: true});
            marker.addListener('dragend', function(evt){
                document.getElementById("ubicacionX").value = evt.latLng.lng();
                document.getElementById("ubicacionY").value = evt.latLng.lat();
            });
        }
        ;
    </script>
                            ...
                            <div class="w3-card-2 w3-round w3-white">
                                <div class="w3-container w3-padding">
                                    ...
                                    <form method="GET" action="/Clase1/agregarPuesto">
                                        ...
                                        <p>
                                        <div id="map"></div>
                                        <input id="ubicacionX" name="ubicacionX" value="">
                                        <p>
                                        <input id="ubicacionY" name="ubicacionY" value="">
                                        <p>
